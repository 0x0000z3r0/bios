...
typedef struct {
    ...
    UINT8   Minute;             // 0 – 59
    UINT8   Second;             // 0 – 59
    UINT8   Pad1; UINT32   Nanosecond;  // 0 – 999,999,999
...
typedef struct {
    ...
    EFI_IMAGE_START StartImage; // EFI 1.0+UEFI Specification, Version 2.8 EFI System Table
    ...
    EFI_SET_MEM SetMem; // EFI 1.1+UEFI Specification, Version 2.8 EFI System Table
